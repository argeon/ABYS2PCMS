...
USING (VALUES
  ...
  ('REF_BANK_SETUP', 120, 'REF', 'BANK', 'setup', N'120_REF_BANK__setup.sql', 1),
  ('REF_BANK_MIGRATE', 121, 'REF', 'BANK', 'migrate', N'121_REF_BANK__migrate.sql', 1),
  ('REF_BANK_POST', 122, 'REF', 'BANK', 'post', N'122_REF_BANK__post.sql', 1),
  ('REF_BANK_CHECK', 123, 'REF', 'BANK', 'check', N'123_REF_BANK__check.sql', 1),
  ...
  ('REF_FUID_SETUP', 140, 'REF', 'FUID', 'setup', N'140_REF_FUID__setup.sql', 2),
  ('REF_FUID_MIGRATE', 141, 'REF', 'FUID', 'migrate', N'141_REF_FUID__migrate.sql', 1),
  ...
  ('MASTER_ITEMS_SETUP', 240, 'MASTER', 'ITEMS', 'setup', N'240_MASTER_ITEMS__setup.sql', 2),
  ('MASTER_ITEMS_MIGRATE', 241, 'MASTER', 'ITEMS', 'migrate', N'241_MASTER_ITEMS__migrate.sql', 2),
  ...
  ('READ_HHD_LOC_INV_TRAN_MIGRATE', 521, 'READ', 'HHD_LOC_INV_TRAN', 'migrate', N'521_READ_HHD_LOC_INV_TRAN__migrate.sql', 3),
  ('READ_HHD_LOC_INV_TRAN_CHECK', 523, 'READ', 'HHD_LOC_INV_TRAN', 'check', N'523_READ_HHD_LOC_INV_TRAN__check.sql', 2),
  ('WO_CS_APPOINTMENT_SETUP', 530, 'WO', 'CS_APPOINTMENT', 'setup', N'530_WO_CS_APPOINTMENT__setup.sql', 2),
