...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT
            ...
            CASE WHEN s.RANDEVU_GIRIS_TAR_ IS NULL THEN NULL
                 WHEN CAST(s.RANDEVU_GIRIS_TAR_ AS DATETIME2) < '17530101' THEN NULL
                 WHEN CAST(s.RANDEVU_GIRIS_TAR_ AS DATETIME2) > '99991231 23:59:59.997' THEN NULL
                 ELSE CAST(s.RANDEVU_GIRIS_TAR_ AS DATETIME) END,
            CAST(s.STATUS AS TINYINT),
            ISNULL(TRY_CAST(s.PROJECT_ID AS INT), 0),
            TRY_CAST(s.INSTALLATION_ID_ AS BIGINT),
            CAST(NULL AS INT),
            CAST(NULL AS INT),
            CAST(NULL AS INT),
            ...
            CASE WHEN s.FATURA_TARIHI_ IS NULL THEN NULL
                 WHEN CAST(s.FATURA_TARIHI_ AS DATETIME2) < '17530101' THEN NULL
                 WHEN CAST(s.FATURA_TARIHI_ AS DATETIME2) > '99991231 23:59:59.997' THEN NULL
                 ELSE CAST(s.FATURA_TARIHI_ AS DATETIME) END,
            TRY_CAST(s.FATURA_BEDELI_ AS DECIMAL(18, 0)),
            TRY_CAST(s.FATURA_BEDELI_KDV_ AS DECIMAL(18, 0)),
            TRY_CAST(s.FATURA_NUMARASI_ AS DECIMAL(18, 0)),
            CAST(NULL AS DATETIME),
            CAST(NULL AS DATETIME),
            CAST(NULL AS INT),
            CAST(NULL AS INT),
            ...
            s.CREATED_TIMESTAMP,
            s.UPDATED_TIMESTAMP,
            CAST(s.FATURA_TARIHI_ AS DATETIME2(0)),
            s.FATURA_BEDELI_,
            s.FATURA_BEDELI_KDV_,
            s.FATURA_NUMARASI_,
            s.INSTALLATION_ID_,
            s.AGR_INSTALLATION_ID_,
            CAST(s.RANDEVU_GIRIS_TAR_ AS DATETIME2(0))
