...
BEGIN
    ...
    BEGIN
        IF @RaiseOnMissing = 1
            RAISERROR('izgazMGR.dbo.LS_AGREEMENT_AUTO_PAYMENT_LOG bulunamadi.', 16, 1);
        RETURN 1;
    END
    ...
    BEGIN
        DECLARE @Msg NVARCHAR(4000) = N'LS_AGREEMENT_AUTO_PAYMENT_LOG eksik kolonlar: ' + @Missing;
    ...
    IF @RaiseOnMissing = 0
        SELECT N'LS_AGREEMENT_AUTO_PAYMENT_LOG kaynak dogrulama OK' AS VALIDATION_MESSAGE;
