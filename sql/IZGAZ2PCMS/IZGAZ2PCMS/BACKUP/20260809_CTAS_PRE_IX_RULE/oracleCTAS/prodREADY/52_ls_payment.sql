-- =============================================================================
-- prodREADY / 52 — LS_PAYMENT (makbuz grain — senaryo diag / wizard aynı grain)
...
SELECT /*+ PARALLEL(56) */
    ...
    CAST(NULL AS VARCHAR2(40))                                   AS TAH_MAKBUZ_SERIAL,
    CAST(NULL AS VARCHAR2(80))                                   AS BANK_RECORD_REF,
...
CREATE UNIQUE INDEX MIGRATION.IX_LS_PAYMENT_PAY ON MIGRATION.LS_PAYMENT (PAY_LREF) PARALLEL 56 NOLOGGING;
CREATE INDEX MIGRATION.IX_LS_PAYMENT_AGR ON MIGRATION.LS_PAYMENT (SOZLESME) PARALLEL 56 NOLOGGING;
CREATE INDEX MIGRATION.IX_LS_PAYMENT_MAIN ON MIGRATION.LS_PAYMENT (MAIN_LREF_FIRST) PARALLEL 56 NOLOGGING;
ALTER INDEX MIGRATION.IX_LS_PAYMENT_PAY NOPARALLEL;
ALTER INDEX MIGRATION.IX_LS_PAYMENT_AGR NOPARALLEL;
ALTER INDEX MIGRATION.IX_LS_PAYMENT_MAIN NOPARALLEL;
ALTER TABLE MIGRATION.LS_PAYMENT NOPARALLEL LOGGING;

BEGIN DBMS_STATS.GATHER_TABLE_STATS('MIGRATION','LS_PAYMENT', degree => 40); END;
/
