...
CREATE UNIQUE INDEX MIGRATION.UX_LS_ADJ_COEF_LREF
    ON MIGRATION.LS_ADJUSTMENT_COEFFICIENT (LREF) NOLOGGING PARALLEL 4;
ALTER INDEX MIGRATION.UX_LS_ADJ_COEF_LREF NOPARALLEL;

CREATE UNIQUE INDEX MIGRATION.UX_LS_ADJ_COEF_NAT
    ON MIGRATION.LS_ADJUSTMENT_COEFFICIENT (TYPE, YEAR, MONTH, DEBTH)
    NOLOGGING PARALLEL 4;
ALTER INDEX MIGRATION.UX_LS_ADJ_COEF_NAT NOPARALLEL;

BEGIN
  DBMS_STATS.GATHER_TABLE_STATS('MIGRATION', 'LS_ADJUSTMENT_COEFFICIENT', degree => 8);
END;
/
