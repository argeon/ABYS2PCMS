/* ============================================================
   ...
   VERSION   : 6
   ============================================================ */
-- v6: remaining IOCODE=0 (ISNULL yasak); canonic path = prodREADY_ENERGY3007/
--     ERR AGR → driver MIG_613_ERR (50e), SP swallow etmez
-- v5: per-AGR hot INSERT/UPDATE OPTION (MAXDOP 8) — CXSYNC DOP48 thrash
...
PRINT '613_INSTALLMENT_DEBT_SPLIT OK (normalize + split v6, CHECKIDENT optional)';
GO
