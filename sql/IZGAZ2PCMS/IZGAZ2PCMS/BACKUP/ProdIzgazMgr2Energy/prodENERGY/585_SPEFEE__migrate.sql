...
BEGIN
    ...
    SELECT @SourceCount  = COUNT_BIG(*) FROM energy.dbo.VW_MIG_SPEFEE_SOURCE;
    SELECT @MaxBridgeKey = MAX(ABYS_ID) FROM energy.dbo.VW_MIG_SPEFEE_SOURCE;
    ...
    BEGIN
        ...
        BEGIN TRY
            ...
            WHERE s.ABYS_ID BETWEEN @BatchFrom AND @BatchTo
              AND NOT EXISTS (
                  SELECT 1
                  FROM energy.dbo.LS_005_01_SPEFEE t
...
-- EXEC energy.dbo.SP_MIGRATE_LS_SPEFEE @HARD_RESET = 1, @DEBUG = 1;
