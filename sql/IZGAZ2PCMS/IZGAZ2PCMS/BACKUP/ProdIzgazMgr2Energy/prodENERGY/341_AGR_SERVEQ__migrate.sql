...
-- AGRID   : kaynak AGRID (= AGR.ABYS_ID; wire yok)
...
-- Aktif sözleşmeye bağlı pasif SERVEQ satırlarını açar (AGRID = AGR.ABYS_ID; wire yok)
...
BEGIN
    ...
    INNER JOIN energy.dbo.LS_005_01_AGR agr ON agr.ABYS_ID = srv.AGRID
