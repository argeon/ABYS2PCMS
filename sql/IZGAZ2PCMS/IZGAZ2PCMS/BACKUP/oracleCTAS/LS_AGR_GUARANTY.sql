...
CREATE INDEX MIGRATION.IDX_LS_GRNT_ABYS_AGR
    ON MIGRATION.LS_AGR_GUARANTY (ABYS_AGREEMENT_ID) NOLOGGING PARALLEL 4;

ALTER INDEX MIGRATION.IDX_LS_GRNT_AGRID    NOPARALLEL;
ALTER INDEX MIGRATION.IDX_LS_GRNT_GTYPE    NOPARALLEL;
ALTER INDEX MIGRATION.IDX_LS_GRNT_ABYS_AGR NOPARALLEL;
