...
-- RISK: LINENR NUMBER(5) — energy 581 CAST TINYINT; MAX>255 satir dusurur
--       (clamp YOK — duplicate LINENR). O12 sonrasi diag_linenr_gt_255.sql
-- =============================================================================
...
SELECT /*+ PARALLEL(56) */
    ...
    /* NUMBER(5)=SMALLINT enerji; 581 hâlâ TINYINT — clamp etme */
    CAST(
      ROW_NUMBER() OVER (
...
PROMPT ========== 12 LS_INVLINES OK — INV_LINENR_GT255>0 ise energy LINENR SMALLINT sart ==========
/