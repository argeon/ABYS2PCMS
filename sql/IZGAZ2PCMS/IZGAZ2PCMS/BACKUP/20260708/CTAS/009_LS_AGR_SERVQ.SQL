...
CREATE INDEX MIGRATION.IDX_LS_SERVQ_AGRID
    ON MIGRATION.LS_AGR_SERVQ (AGRID) NOLOGGING PARALLEL 4;

CREATE INDEX MIGRATION.IDX_LS_SERVQ_TP2
    ON MIGRATION.LS_AGR_SERVQ (TP2) NOLOGGING PARALLEL 4;

CREATE INDEX MIGRATION.IDX_LS_SERVQ_ITEMID
    ON MIGRATION.LS_AGR_SERVQ (ITEMID) NOLOGGING PARALLEL 4;

ALTER INDEX MIGRATION.IDX_LS_SERVQ_AGRID  NOPARALLEL;
ALTER INDEX MIGRATION.IDX_LS_SERVQ_TP2    NOPARALLEL;
ALTER INDEX MIGRATION.IDX_LS_SERVQ_ITEMID NOPARALLEL;

BEGIN
  DBMS_STATS.GATHER_TABLE_STATS('MIGRATION', 'LS_AGR_SERVQ', cascade => TRUE, degree => 4);
END;
/
