...
CREATE UNIQUE INDEX MIGRATION.UX_LS_KFACTOR_VALUE_LREF
    ON MIGRATION.LS_KFACTOR_VALUE (LREF) NOLOGGING PARALLEL 4;
ALTER INDEX MIGRATION.UX_LS_KFACTOR_VALUE_LREF NOPARALLEL;

CREATE UNIQUE INDEX MIGRATION.UX_LS_KFACTOR_VALUE_NAT
    ON MIGRATION.LS_KFACTOR_VALUE (ACTION_DATE, SERVICE_BOX_ID, IS_MONTHLY)
    NOLOGGING PARALLEL 4;
ALTER INDEX MIGRATION.UX_LS_KFACTOR_VALUE_NAT NOPARALLEL;

CREATE INDEX MIGRATION.IDX_LS_KFACTOR_VALUE_SB
    ON MIGRATION.LS_KFACTOR_VALUE (SERVICE_BOX_ID) NOLOGGING PARALLEL 4;
ALTER INDEX MIGRATION.IDX_LS_KFACTOR_VALUE_SB NOPARALLEL;

BEGIN
  DBMS_STATS.GATHER_TABLE_STATS('MIGRATION', 'LS_KFACTOR_VALUE', degree => 16);
END;
/
