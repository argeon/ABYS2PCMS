  ...
  public static void main(String[] a) throws Exception {
    ...
    try (Connection c = DriverManager.getConnection(
      ...
      for (String t : new String[]{
        "LS_OV_PAY_PT","LS_OV_TAH_INVOICE","LS_OV_DEBT_PAID_UPD","LS_OV_CANCEL_PAY","LS_OV_CANCEL_REV",
        "LS_OV_TAM_HAS_PAY","LS_OV_MAHSUP_SRC","LS_OV_MAHSUP_CLOSED","LS_OV_TAH_LOG"
