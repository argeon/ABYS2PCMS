...
--
-- Pilot : MIG_PARAM.AGR_ID dolu → listedeki sozlesmeler (coklu OK; MIG_PARAM_seed.sql)
-- Full  : INSERT'i kaldirin / AGR_ID NULL yapin ve filtreyi NOT EXISTS ile genisletin
--
...
-- =============================================================================
-- 00. MIG_PARAM (coklu pilot AGR — bkz. MIG_PARAM_seed.sql)
-- =============================================================================
BEGIN
...
-- Pilot set (coklu senaryo). Full run: tabloyu bos birakin / AGR_ID NULL.
-- Yeniden seed: oracleCTAS/MIG_PARAM_seed.sql
INSERT INTO MIGRATION.MIG_PARAM (AGR_ID) VALUES (276503);
INSERT INTO MIGRATION.MIG_PARAM (AGR_ID) VALUES (556305);
INSERT INTO MIGRATION.MIG_PARAM (AGR_ID) VALUES (197168);
INSERT INTO MIGRATION.MIG_PARAM (AGR_ID) VALUES (5727);
INSERT INTO MIGRATION.MIG_PARAM (AGR_ID) VALUES (2221);
INSERT INTO MIGRATION.MIG_PARAM (AGR_ID) VALUES (978259);
INSERT INTO MIGRATION.MIG_PARAM (AGR_ID) VALUES (1192595);
COMMIT;
...
SELECT /*+ FULL(aca) FULL(ai) PARALLEL(8) USE_HASH(aca ai) */
    aca.ACCOUNT_ID,
    aca.ID                                                              AS ACA_ID,
...
WHERE aca.ACTION_TYPE_ID IN (1, 3, 10, 41)
  ...
  AND a.AGREEMENT_ID IN (SELECT P.AGR_ID FROM MIGRATION.MIG_PARAM P WHERE P.AGR_ID IS NOT NULL)
...
PARALLEL 8
AS
SELECT /*+ PARALLEL(8) FULL(aa) FULL(acc) FULL(av) USE_HASH(aa acc av) */
...
WHERE aa.ACTION_TYPE_ID IN (1, 3, 10, 41)
  ...
  AND acc.AGREEMENT_ID IN (SELECT P.AGR_ID FROM MIGRATION.MIG_PARAM P WHERE P.AGR_ID IS NOT NULL);
