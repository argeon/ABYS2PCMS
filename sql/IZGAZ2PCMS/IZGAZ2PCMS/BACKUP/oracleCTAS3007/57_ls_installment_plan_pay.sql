...
CREATE INDEX MIGRATION.IX_LS_IPP_INST ON MIGRATION.LS_INSTALLMENT_PLAN_PAY (INSTALLMENT_ID) PARALLEL 56 NOLOGGING;
CREATE INDEX MIGRATION.IX_LS_IPP_AGR ON MIGRATION.LS_INSTALLMENT_PLAN_PAY (AGREEMENT_ID) PARALLEL 56 NOLOGGING;
CREATE INDEX MIGRATION.IX_LS_IPP_PAID ON MIGRATION.LS_INSTALLMENT_PLAN_PAY (IS_PAID) PARALLEL 56 NOLOGGING;
CREATE INDEX MIGRATION.IX_LS_IPP_MAIN ON MIGRATION.LS_INSTALLMENT_PLAN_PAY (MAIN_LREF) PARALLEL 56 NOLOGGING;
ALTER INDEX MIGRATION.IX_LS_IPP_INST NOPARALLEL;
ALTER INDEX MIGRATION.IX_LS_IPP_AGR NOPARALLEL;
ALTER INDEX MIGRATION.IX_LS_IPP_PAID NOPARALLEL;
ALTER INDEX MIGRATION.IX_LS_IPP_MAIN NOPARALLEL;
ALTER TABLE MIGRATION.LS_INSTALLMENT_PLAN_PAY NOPARALLEL LOGGING;

BEGIN DBMS_STATS.GATHER_TABLE_STATS('MIGRATION','LS_INSTALLMENT_PLAN_PAY', degree => 40); END;
/
