...
-- =============================================================================
-- oracleCTAS3007 / 31 — PAY ALLOC WATERFILL ONLY (yuvarlama / over-alloc fix)
...
--
-- FIX (2026-08-02) — ACTION_DATE<=PAY kaldirildi (O30 ana dosya ile ayni).
-- FIX (2026-08-02c) — iptal PAY: ALLOC+CANCELED=1; MAIN waterfill yalniz gecerli (O30 ile ayni).
--
...
FROM (
    /* Iptal tahsilat da TYPE=101 TAH_INV (CANCELED=1) — O30 ile ayni */
    SELECT x.*,
           ROW_NUMBER() OVER (
