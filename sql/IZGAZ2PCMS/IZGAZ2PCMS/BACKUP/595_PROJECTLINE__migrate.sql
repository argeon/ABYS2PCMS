...
BEGIN
    ...
    INSERT INTO energy.dbo.LS_005_01_PROJECTLINE (
        ...
        ABYS_PAR_ID, ABYS_REF_ID,
        ABYS_LINE_KIND, ABYS_PROJECT_BUILDING_ID, ABYS_PROJECT_INSTALLATION_ID, ABYS_INSTALLATION_ID,
        ABYS_STG_WORKERID2,
        ABYS_STG_TRC_ENG_ID, ABYS_STG_CTRL_ENG_ID,
        ABYS_STG_OLD_PROJECT_STATUS, ABYS_STG_TESISAT_NO,
        ABYS_STG_PROJE_SATIR, ABYS_STG_SERVIS_KUTU_NO, ABYS_STG_PI_TYPE_SET,
    ...
    SELECT
        ...
        s.ABYS_PAR_ID, s.ABYS_REF_ID,
        s.ABYS_LINE_KIND, s.ABYS_PROJECT_BUILDING_ID, s.ABYS_PROJECT_INSTALLATION_ID, s.ABYS_INSTALLATION_ID,
        s.ABYS_STG_WORKERID2,
        s.ABYS_STG_TRC_ENG_ID, s.ABYS_STG_CTRL_ENG_ID,
        s.ABYS_STG_OLD_PROJECT_STATUS, s.ABYS_STG_TESISAT_NO,
        s.ABYS_STG_PROJE_SATIR, s.ABYS_STG_SERVIS_KUTU_NO, s.ABYS_STG_PI_TYPE_SET,
