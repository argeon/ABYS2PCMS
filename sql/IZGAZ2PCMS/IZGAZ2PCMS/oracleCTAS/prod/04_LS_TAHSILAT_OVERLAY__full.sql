...
--
-- Prefab: TMP_MIG_ACC (tum hesaplar ACCRUE<>14) + TMP_PAY_CANCEL (R42 iptal, tek yer)
-- Uretir:
...
--
-- Log AYRI: 05_LS_TAHSILAT_LOG__full.sql (overlay SONRASI; tip12/PAY_NO_ALLOC gozlem)
