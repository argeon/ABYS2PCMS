-- =============================================================================
-- prod2 / 14 — LS_DEBT_PAYTRANS (energy 575 karsiligi — LS_005_01_PAYTRANS IOCODE=0)
...
SELECT /*+ PARALLEL(52) */
    ...
    CAST(NVL(inv.CURID, 160) AS NUMBER(10))                       AS CURID,
    ...
    CAST(inv.TAX AS NUMBER(18,3))                                 AS TAX,
    ...
    CAST(NULL AS NUMBER(12))                                      AS BANKREF,
    ...
    CAST(NVL(inv.CURID, 160) AS NUMBER(10))                       AS PAYCURID,
...
CREATE INDEX MIGRATION.IX_LS_DEBT_PT_INV ON MIGRATION.LS_DEBT_PAYTRANS (INVOICEREF) PARALLEL 52 NOLOGGING;
CREATE INDEX MIGRATION.IX_LS_DEBT_PT_AGR ON MIGRATION.LS_DEBT_PAYTRANS (ABYS_AGREEMENT_ID) PARALLEL 52 NOLOGGING;
CREATE INDEX MIGRATION.IX_LS_DEBT_PT_ABYS ON MIGRATION.LS_DEBT_PAYTRANS (ABYS_ID) PARALLEL 52 NOLOGGING;
...
BEGIN DBMS_STATS.GATHER_TABLE_STATS('MIGRATION', 'LS_DEBT_PAYTRANS', degree => 32); END;
/
...
PROMPT ========== 14 LS_DEBT_PAYTRANS OK (575 Oracle prefab) ==========
/