...
-- DOP: session parallel; index PARALLEL 52 + AGR index (energy LOOP)
--
...
CREATE UNIQUE INDEX MIGRATION.IX_OV_KISMI_PT ON MIGRATION.LS_OV_KISMI_PAYTRANS (LREF);
CREATE INDEX MIGRATION.IX_OV_KISMI_PT_INV ON MIGRATION.LS_OV_KISMI_PAYTRANS (INVOICEREF);

-- =============================================================================
-- 7c) AGR indexes (590 energy LOOP / izgazMGR parity)
-- =============================================================================
CREATE INDEX MIGRATION.IX_OV_IADE_INV_AGR ON MIGRATION.LS_OV_IADE_INVOICE (ABYS_AGREEMENT_ID) PARALLEL 52 NOLOGGING;
CREATE INDEX MIGRATION.IX_OV_MAIN_UPD_AGR ON MIGRATION.LS_OV_MAIN_UPD (ABYS_AGREEMENT_ID) PARALLEL 52 NOLOGGING;
CREATE INDEX MIGRATION.IX_OV_IADE_IL_AGR ON MIGRATION.LS_OV_IADE_INVLINES (ABYS_AGREEMENT_ID) PARALLEL 52 NOLOGGING;
CREATE INDEX MIGRATION.IX_OV_IADE_PT_AGR ON MIGRATION.LS_OV_IADE_PAYTRANS (ABYS_AGREEMENT_ID) PARALLEL 52 NOLOGGING;
CREATE INDEX MIGRATION.IX_OV_KISMI_IL_AGR ON MIGRATION.LS_OV_KISMI_INVLINES (ABYS_AGREEMENT_ID) PARALLEL 52 NOLOGGING;
CREATE INDEX MIGRATION.IX_OV_KISMI_HDR_AGR ON MIGRATION.LS_OV_KISMI_HDR (ABYS_AGREEMENT_ID) PARALLEL 52 NOLOGGING;
CREATE INDEX MIGRATION.IX_OV_KISMI_PT_AGR ON MIGRATION.LS_OV_KISMI_PAYTRANS (ABYS_AGREEMENT_ID) PARALLEL 52 NOLOGGING;
CREATE INDEX MIGRATION.IX_OV_EKS_CLASS_AGR ON MIGRATION.LS_OV_EKS_CLASS (AGREEMENT_ID) PARALLEL 52 NOLOGGING;
