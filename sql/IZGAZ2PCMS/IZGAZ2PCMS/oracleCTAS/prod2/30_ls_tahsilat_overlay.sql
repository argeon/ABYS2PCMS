...
-- Log AYRI: 40_ls_tahsilat_log.sql | Hard gate: 41_gate_tahsilat.sql
-- =============================================================================
...
-- =============================================================================
CREATE INDEX MIGRATION.IX_OV_DEBT_PAID_AGR ON MIGRATION.LS_OV_DEBT_PAID_UPD (ABYS_AGREEMENT_ID) PARALLEL 52 NOLOGGING;
CREATE INDEX MIGRATION.IX_OV_CANCEL_PAY_AGR ON MIGRATION.LS_OV_CANCEL_PAY (ABYS_AGREEMENT_ID) PARALLEL 52 NOLOGGING;
CREATE INDEX MIGRATION.IX_OV_CANCEL_REV_AGR ON MIGRATION.LS_OV_CANCEL_REV (ABYS_AGREEMENT_ID) PARALLEL 52 NOLOGGING;
CREATE INDEX MIGRATION.IX_OV_MAHSUP_SRC_AGR ON MIGRATION.LS_OV_MAHSUP_SRC (ABYS_AGREEMENT_ID) PARALLEL 52 NOLOGGING;
CREATE INDEX MIGRATION.IX_OV_MAHSUP_CLOSED_AGR ON MIGRATION.LS_OV_MAHSUP_CLOSED (ABYS_AGREEMENT_ID) PARALLEL 52 NOLOGGING;
