...
-- DOP: 28 (hash aggregate — PGA/temp)
...
END;
/
CREATE TABLE MIGRATION.STG_INV_ACC_INC NOLOGGING PARALLEL 28 AS
SELECT /*+ FULL(aca) FULL(ai) PARALLEL(28) */
...
BEGIN DBMS_STATS.GATHER_TABLE_STATS('MIGRATION', 'STG_INV_ACC_INC', degree => 32); END;
/
