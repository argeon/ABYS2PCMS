/* ============================================================
   ...
   Ornek: EXEC energy.dbo.SP_MIG_597_ALL @AGR_ID=NULL, @CLEAN=1, @DEBUG=1;
   ============================================================ */
USE energy;
GO
...
BEGIN
    ...
    BEGIN TRY
        ...
        EXEC dbo.SP_MIG_597_INSERT @AGR_ID=@AGR_ID, @CLEAN=@CLEAN, @DEBUG=@DEBUG;

        RAISERROR('---------- E597 faz2 WIRE ----------', 0, 1) WITH NOWAIT;
        EXEC dbo.SP_MIG_597_WIRE   @AGR_ID=@AGR_ID, @DEBUG=@DEBUG;
