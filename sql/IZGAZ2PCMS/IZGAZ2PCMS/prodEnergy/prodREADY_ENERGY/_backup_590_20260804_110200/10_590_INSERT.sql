/* ============================================================
   prodREADY_ENERGY / 10_590_INSERT
   IADE INV/IL/PT + KISMI IL + MAIN_UPD (CANCEL alanlari; RETURN_TARGET sonra WIRE)
   MAP.ENERGY_LREF doldurulur. Tek basina cutover YASAK → 19_590_ALL kullan.
   ============================================================ */
USE energy;
GO
