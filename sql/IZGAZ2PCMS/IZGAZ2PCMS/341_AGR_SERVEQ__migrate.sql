...
-- AGRID   : NULL (AGR tablosu sonrası SP_MIG_WIRE_AGR_SERVEQ_AGRID)
-- ============================================================
USE energy;
GO
...
BEGIN
    ...
    SELECT
        ...
        s.MID, s.TID, NULL, s.CALCPRESSID, s.TYPE_, s.SNO, s.MIDOLD, s.LASTENDEX,
...
-- EXEC energy.dbo.SP_MIG_WIRE_AGR_SERVEQ_AGRID @Debug = 1;  -- AGR migrate sonrasi
