...
BEGIN
    ...
    ;WITH Required (COL_NAME) AS (
        ...
        FROM (VALUES
            ...
            ('INVOICE_ID'), ('STATID'),
            ('STG_PROJECT_YEAR'), ('STG_PROJECT_NUMBER'),
            ('STG_ORA_TYPE_ID'), ('STG_PI_TYPE_SET'),
            ('STG_HASMOD'), ('STG_ORA_STATUS')
        ) v(COL_NAME)
    )
...
SELECT
    ...
    CAST(s.STG_PROJECT_YEAR AS SMALLINT)                                    AS ABYS_STG_PROJECT_YEAR,
    CAST(s.STG_PROJECT_NUMBER AS BIGINT)                                    AS ABYS_STG_PROJECT_NUMBER,
    CAST(s.STG_ORA_TYPE_ID AS BIGINT)                                       AS ABYS_STG_ORA_TYPE_ID,
    s.STG_PI_TYPE_SET                                                       AS ABYS_STG_PI_TYPE_SET,
    TRY_CAST(s.STG_HASMOD AS DECIMAL(22, 0))                                AS ABYS_STG_HASMOD,
    CAST(s.STG_ORA_STATUS AS SMALLINT)                                      AS ABYS_STG_ORA_STATUS,
