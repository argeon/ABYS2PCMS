...
--   AGRID ← kaynak AGRID (doğrudan; AGR.LREF ile aynı, wire yok)
--   ISACTIVE ← kaynak; aktif AGR için 341/910 SP_MIG_AGR_SERVEQ_SYNC_ISACTIVE
...
-- ------------------------------------------------------------
-- Kaynak view
-- AGRID insert'te ABYS_AGREEMENT_ID (= kaynak AGRID) olarak yazılır; wire yok
