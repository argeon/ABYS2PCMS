...
BEGIN
    ...
    ;WITH Required (COL_NAME) AS (
        SELECT v.COL_NAME FROM (VALUES
            ...
            ('IS_ADJUSTABLE')
            -- Opsiyonel (196 dump'ta yok): FATURA_*_ / INSTALLATION_ID_ / AGR_INSTALLATION_ID_ / RANDEVU_GIRIS_TAR_
        ) v(COL_NAME)
    )
...
SELECT
    ...
    -- 196 dump: FATURA_*_ / INSTALLATION_ID_ / RANDEVU_GIRIS_TAR_ yok → NULL
    CAST(NULL AS DATETIME2(0))                                              AS ABYS_FATURA_TARIHI_,
    CAST(NULL AS DECIMAL(22, 0))                                            AS ABYS_FATURA_BEDELI_,
    CAST(NULL AS DECIMAL(22, 0))                                            AS ABYS_FATURA_BEDELI_KDV_,
    CAST(NULL AS DECIMAL(22, 0))                                            AS ABYS_FATURA_NUMARASI_,
    CAST(NULL AS DECIMAL(22, 0))                                            AS ABYS_INSTALLATION_ID_,
    CAST(NULL AS DECIMAL(22, 0))                                            AS ABYS_AGR_INSTALLATION_ID_,
    CAST(NULL AS DATETIME2(0))                                              AS ABYS_RANDEVU_GIRIS_TAR_,
    ...
    CAST(NULL AS DATETIME)                                                  AS APPOINTMENT_DATE,      -- RANDEVU_GIRIS_TAR_ yok
    ...
    CAST(NULL AS BIGINT)                                                    AS FITNO,                 -- INSTALLATION_ID_ yok
    ...
    CAST(NULL AS DATETIME)                                                  AS FATURA_TARIHI,
    CAST(NULL AS DECIMAL(18, 0))                                            AS FATURA_BEDELI,
    CAST(NULL AS DECIMAL(18, 0))                                            AS FATURA_BEDELI_KDV,
    CAST(NULL AS DECIMAL(18, 0))                                            AS FATURA_NUMARASI,
